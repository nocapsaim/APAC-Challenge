...
class RegisterAsBusinessOwner extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildInputField(companyNameController, 'Company Name'),
            const SizedBox(height: 16),
            _buildInputField(companyAddressController, 'Company Address'),
            const SizedBox(height: 24),
            ...
            const Center(
              child: Text(
                'By tapping “Sign Up” you accept our terms\nand condition',
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: isPassword
              ? Icon(Icons.visibility, color: Colors.grey.shade400)
              : null,
        ),
      ),
    );
