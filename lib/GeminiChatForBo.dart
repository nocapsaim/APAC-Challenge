...
class GeminiChatForBo extends StatefulWidget {
  const GeminiChatForBo({super.key});

  @override
  _GeminiChatForBoState createState() => _GeminiChatForBoState();
}

class _GeminiChatForBoState extends State<GeminiChatForBo> {
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: const Icon(Icons.send, color: Color(0xFF6A4DFF)),
